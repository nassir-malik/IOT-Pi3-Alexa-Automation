...
1. Go to run & type "cmd" and type arp -a in command prompt. Look for "Physical Addres" that starts with b8-27\* & note the Internet Address. This is your Raspberry Pi3 Wi-fi IP address on your network.
