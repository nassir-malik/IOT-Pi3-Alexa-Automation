...
1. Entery "sudo pip install virtualenv" command to install virtualenv on Pi
1. Enter "virtualenv ipaa-env" command to create virtual environment for your project
1. Enter ". ipaa-env/bin/activate" command to activate your project's virtualen vironment
